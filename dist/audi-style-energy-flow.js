...
(function () {
  ...
  const DAY_CLEAR_IDLE_PATHS = Object.freeze({
    ...
    'line-grid-load': 'M 434 402 Q 434 402 351 375 Q 352 340 365 350',
    ...
    'line-wallbox-ev2': 'M 356 341 Q 357 340 356 375 L 439 402 L 470 390',
  });
  ...
  const DAY_CLEAR_IDLE_COMPONENTS = Object.freeze({
    ...
    'grid-label': Object.freeze({ x: 46, y: 89 }),
    'grid-power': Object.freeze({ x: 46, y: 111 }),
  ...
  const DAY_CLEAR_CHARGING_COMPONENTS = Object.freeze({
    ...
    'grid-label': Object.freeze({ x: 60, y: 105 }),
    'grid-power': Object.freeze({ x: 60, y: 127 }),
  ...
  const SCENE_FLOW_COMPONENT_MAP = Object.freeze({
    ...
    'scene_night_clear_charging.png': Object.freeze({
      ...
      'solar-guide': Object.freeze({ x1: 0, y1: -92, x2: 0, y2: -12 }),
      'grid-label': Object.freeze({ x: 20, y: 0 }),
      'grid-power': Object.freeze({ x: 20, y: 22 }),
